...
public class ExampleICPrinter {
	...
	public ExampleICPrinter(List<Quat> quats,Map<String,SymbolTable> functable,Map<String,SymbolTable> subscopetable) {
		this.quats = quats;
	...
	public void print(String filename) {
		...
		for (Quat quat : quats) {
			...
			if(op.equals("Func_Beg")||op.equals("Scope_Beg")) {
				...
				if(op.equals("var")||op.equals("param")||op.equals("arr"))
					continue;
				String res = astStr(quat.getRes());
				String opnd1 = astStr(quat.getOpnd1());
