...
judge proc buFlag:byte,rival:byte
	...
	.if rivalnum==0||flag_ctn==0
		...
		.while TRUE
			...
			.break .if esi>=sz*sz || esi<0
			.if buFlag==1
				invoke SetDlgItemText,hW,esi,addr buend
			.elseif buFlag==2
				invoke SetDlgItemText,hW,esi,addr buend
			.endif
